...
import initLayout from 'opentok-layout-js';
...
var createOverlay = function createOverlay(_ref) {
  ...
  var overlay = Object.assign(new EventEmitter(), {
...
var Subscriber = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Subscriber(otSubscriber) {
    ...
    var audioLevelUpdatedHandler = throttle(_onAudioLevelUpdated, 60, {
...
var LayoutManager = /*#__PURE__*/function (_EventEmitter) {
  ...
  function LayoutManager(targetElement, layoutOptions, maxVideoParticipantsOnScreen) {
    ...
    _this._initContainerResizeListener = function () {
      var throttledRecalculateLayout = throttle(function () {
    ...
    _this._emitLayoutRecalculated = debounce(function () {
...
var ActiveSpeakerTracker = /*#__PURE__*/function (_EventEmitter) {
  ...
  function ActiveSpeakerTracker() {
    ...
    _this.calculateActiveSpeaker = throttle(_this._calculateActiveSpeaker, CALCULATE_ACTIVE_SPEAKER_THROTTLE_TIME, {
...
export { PreviewPublisher, RoomWrapper as Room, getActiveAudioOutputDevice, getAudioOutputDevices, getDevices, hasMediaProcessorSupport, logLevel, setAudioOutputDevice, setLogLevel, setProxyUrl, version };
//# sourceMappingURL=video-express.esm.js.map
